...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		...
		if (App.getUserRole() === Enums.UserRole.SuperAdmin)
		{
			...
			__webpack_require__(/*! modules/LogsViewerWebclient/js/enums.js */ 338);
					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/LogsViewerWebclient/js/views/AdminSettingsView.js */ 339));
								});
						},
