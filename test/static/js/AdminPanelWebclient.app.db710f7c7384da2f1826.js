			...
			return {
				start: function () {
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/DbAdminSettingsView.js */ 241));
								});
						},
					...
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/SecurityAdminSettingsView.js */ 242));
								});
						},
					...
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/CommonSettingsPaneView.js */ 243));
								});
						},
						TabName: 'common',
					...
					oScreens[Settings.HashModuleName] = function () {
						...
						return new Promise(function(resolve, reject) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function(require) {
									var
										oSettingsView = __webpack_require__(/*! modules/AdminPanelWebclient/js/views/SettingsView.js */ 234),
										aPromises = []
									;
				...
				getAbstractSettingsFormViewClass: function () {
					return __webpack_require__(/*! modules/AdminPanelWebclient/js/views/CAbstractSettingsFormView.js */ 232);
				},
				...
				setAddHash: function (aAddHash) {
					var SettingsView = __webpack_require__(/*! modules/AdminPanelWebclient/js/views/SettingsView.js */ 234);
